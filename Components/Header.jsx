  ...
  return (
    <div className='py-5 px-5 '>
      <div className="flex justify-between items-center">
        ...
        <button className='flex items-center gap-2 font-medium py-1 px-3  border border-solid border-black shadow-[-7px_7px_0px_#000000]'>Get Started<Image src={assets.arrow}/></button>
      </div>
      <div className='text-center my-8'>
        <h1 className='text-3xl font-medium'>Latest Blogs</h1>
        <p className='mt-10 max-w-[740px] m-auto text-xs '>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Veritatis ducimus tenetur corrupti repellendus, temporibus deserunt nam ab excepturi sit dicta sequi sint aperiam corporis, minima accusamus illo ex esse fugiat.</p>
